...
<body>
    <header class="head">
        ...
        <div class="side-bar"><a href="inin.jsp">Login</a>
    ...
    <section class="home" id="home">
        <div class="home-content">
            ...
            <div class="form-box">
                <center><h3> Admin </h3></center><br>
                <a href="AdminLogin.html">
                <center><img src="AdminAvater.jpg" height=150 width=200></img></a>
                <br><br><br>
                <center><h3> User </h3></center><br>
                <a href="UserLogin.html">
                <center><img src="UserImage.jpg" height=150 width=200></img></a>
                </center>
            </a>
...
<section class="service" id="service">
    ...
    <div class="service-content">
        <div class="inner-box">
            ...
            <h2>Free Delivery</h2>
            <p>Given the evolving COVID-19 situation, we wanted to reassure you that the safety and wellbeing of customers and colleagues is always our top priority.</p>
            <button class="btn">Read More</button>
        </div>
        <div class="inner-box">
            <img src="./resources/images/s-2.jpg" alt="">
            <h2>Online Payment</h2>
            <p>The main advantages of using online payment are cost and time savings, increased sales, and reduced transaction costs.</p>
            <button class="btn">Read More</button>
        </div>
        <div class="inner-box">
            <img src="./resources/images/s-3.png" alt="">
            <h2>Fresh Food</h2>
            <p>Fresh fruits and vegetables are an important part of a healthy diet. They contain essential vitamins, minerals, fiber and other nutrients that are essential for good health.</p>
            <button class="btn">Read More</button>
        </div>
    </div>
</section>
        ...
        <div class="contact-inner">
            ...
            <div class="contact-inner-col">
                ...
                <form action="#" id="" method="get">
                    ...
                    <input type="tel" name="name" pattern="[0-9]{10}" id=" " placeholder="Phone Number" required>
